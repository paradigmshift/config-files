...
(setq org-todo-keywords
      (quote ((sequence "CAPTURED(c)" "NEXT(n)" "DEFERRED(f)" "WAITING(w)" "|" "DONE(d)"))))
...
(setq org-agenda-custom-commands
      '((" " "Agenda"
         ((agenda "" ((org-agenda-ndays 1))) 
          (todo "CAPTURED" ((org-agenda-overriding-header "Captured")
                            (org-agenda-files '("~/notes/notes.org"))))
          (tags "-@projects/NEXT" ((org-agenda-overriding-header "Next Actions")
                                   (org-agenda-files '("~/notes/notes.org"))))
          (todo "WAITING" ((org-agenda-overriding-header "Waiting")
                           (org-agenda-files '("~/notes/notes.org"))))
          (tags "@roby" ((org-agenda-overriding-header "Delegated")))
          (tags "-@projects/DEFERRED" ((org-agenda-overriding-header "Deferred")
                                       (org-agenda-files '("~/notes/notes.org"))))
          ...
          (tags "@projects/NEXT" ((org-agenda-overriding-header "Shala-Sys Next Tasks")
